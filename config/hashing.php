...
return [
    ...
    */
    ...
    |
    | Set "verify" to false to allow verification of hashes created with other
    | algorithms (e.g. Argon2). PHP's password_verify() still validates
    | correctly; this only disables the strict algorithm check.
    |
    */
