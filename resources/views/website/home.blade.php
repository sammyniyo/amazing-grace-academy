...
@section('content')
        ...
        <div class="ui-hero-panel">
            <div class="grid items-center gap-12 lg:grid-cols-2 px-8 py-12 sm:px-12 lg:px-14">
                <div class="reveal space-y-6">
                    <div
                        class="inline-flex items-center gap-2 rounded-full border border-sage-200/80 bg-white/90 px-4 py-1.5 text-xs font-semibold text-sage-700 tracking-wide shadow-sm">
                        Sacred music academy • Since 2016
                    </div>

                    <h1
                        class="font-display text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-ink-900 leading-[1.08]">
                    ...
                    <div class="flex flex-wrap gap-2 text-sm text-ink-700">
                        <span class="rounded-full border border-sage-200/80 bg-white/80 px-3.5 py-1.5 font-medium">Sol-Fa &
                            staff literacy</span>
                        <span class="rounded-full border border-sage-200/80 bg-white/80 px-3.5 py-1.5 font-medium">Choir
                            leadership</span>
                        <span class="rounded-full border border-sage-200/80 bg-white/80 px-3.5 py-1.5 font-medium">Piano •
                            Guitar • Violin</span>
                    </div>

                    <div class="flex flex-wrap gap-3">
                        <x-ui.button href="{{ url('/register') }}" variant="primary" class="rounded-full px-6 py-3">Join
                            class</x-ui.button>
                        <x-ui.button href="{{ route('songs') }}" variant="outline" class="rounded-full px-6 py-3">Shop
                            music</x-ui.button>
                    </div>

                    <div class="grid gap-3 sm:grid-cols-3 text-sm text-ink-600">
                        <div
                            class="rounded-2xl border border-sage-100 bg-white/80 px-4 py-3.5 shadow-sm transition-shadow hover:shadow-card">
    ...
    <section class="mx-auto max-w-7xl px-6 pb-24">
        <div class="grid gap-6 md:grid-cols-3">
            <div class="reveal soft-card p-8 transition-all duration-300 hover:-translate-y-0.5">
                ...
                <x-ui.button href="{{ route('programs') }}" variant="primary" class="mt-6 w-full rounded-xl">View
            ...
            <div class="reveal reveal-delay-1 soft-card p-8 transition-all duration-300 hover:-translate-y-0.5">
                ...
                <x-ui.button href="{{ route('songs') }}" variant="outline" class="mt-6 w-full rounded-xl">Explore
                    Songs</x-ui.button>
            </div>
            <div class="reveal reveal-delay-2 soft-card p-8 transition-all duration-300 hover:-translate-y-0.5">
                ...
                <x-ui.button href="{{ route('contact') }}#support" variant="ghost" class="mt-6 w-full rounded-xl">Support
                    the Academy</x-ui.button>
            </div>
        </div>
    </section>
    ...
    <section class="mx-auto max-w-7xl px-6 pb-20">
        <div class="reveal flex items-center justify-between gap-6 flex-wrap">
            ...
            <x-ui.button href="{{ route('programs') }}" variant="outline" class="rounded-full hidden sm:inline-flex">Explore
                Programs</x-ui.button>
        </div>
        ...
        <div class="mt-10 grid gap-6 md:grid-cols-3">
            <div class="reveal soft-card overflow-hidden group">
                <div class="overflow-hidden">
                    <img src="{{ asset('images/aga-girls.jpg') }}" alt="Sol-Fa class photo"
                        class="h-52 w-full object-cover transition-transform duration-500 group-hover:scale-105"
                        loading="lazy" width="400" height="208">
                </div>
                <div class="p-6 space-y-3">
                    ...
                    <p class="text-sm text-ink-600 leading-relaxed">Learn to read and sing SATB parts correctly using church
                        hymnals.</p>
            ...
            <div class="reveal reveal-delay-1 soft-card overflow-hidden group">
                <div class="overflow-hidden">
                    <img src="{{ asset('images/aga-boys1.jpg') }}" alt="Staff notation session"
                        class="h-52 w-full object-cover transition-transform duration-500 group-hover:scale-105"
                        loading="lazy" width="400" height="208">
                </div>
                <div class="p-6 space-y-3">
                    ...
                    <p class="text-sm text-ink-600 leading-relaxed">Advance to international notation for choir, solo, and
                        instrumental work.</p>
                    <div class="flex gap-2 flex-wrap">
            ...
            <div class="reveal reveal-delay-2 soft-card overflow-hidden group">
                <div class="overflow-hidden">
                    <img src="{{ asset('images/aga-boys2.jpg') }}" alt="Instrument practice"
                        class="h-52 w-full object-cover transition-transform duration-500 group-hover:scale-105"
                        loading="lazy" width="400" height="208">
                </div>
                <div class="p-6 space-y-3">
                    ...
                    <p class="text-sm text-ink-600 leading-relaxed">Apply music reading to instruments and worship
                        performance.</p>
                    <div class="flex gap-2 flex-wrap">
    ...
    <section class="mx-auto max-w-7xl px-6 pb-20">
        <div class="reveal">
            ...
            <p class="mt-2 text-ink-600 max-w-3xl leading-relaxed">A clear, paced journey with milestones and expected
                outcomes.</p>
        </div>
    ...
    <section class="mx-auto max-w-7xl px-6 pb-20">
        <div class="reveal flex items-center justify-between gap-6 flex-wrap">
            <div>
                ...
                <p class="mt-2 text-ink-600 max-w-2xl leading-relaxed">Join the next intake or worship events across
                    Rwanda.</p>
            </div>
    ...
    <section class="mx-auto max-w-7xl px-6 pb-20">
        <div class="reveal flex items-center justify-between gap-6 flex-wrap">
            ...
            <x-ui.button href="{{ route('songs') }}" variant="outline" class="rounded-full hidden sm:inline-flex">See
                Performances</x-ui.button>
        </div>
            ...
            <div class="lg:col-span-2 reveal soft-card p-8">
                ...
                <div class="mt-6 space-y-5">
                    <div class="border-b border-ink-100 pb-5">
                        ...
                        <p class="text-sm text-ink-600 mt-1 leading-relaxed">Yes. We serve the church; learners invest time
                            and commitment.</p>
                    </div>
                    <div class="border-b border-ink-100 pb-5">
                        <div class="text-sm font-semibold text-ink-900">Do I need prior music knowledge?</div>
                        <p class="text-sm text-ink-600 mt-1 leading-relaxed">No. We start from zero, including those who
                            cannot read notation.</p>
                    </div>
                    <div class="pb-2">
                        <div class="text-sm font-semibold text-ink-900">Can churches invite the academy?</div>
                        <p class="text-sm text-ink-600 mt-1 leading-relaxed">Yes. We support evangelism programs, concerts,
                            and choir training.</p>
                    </div>
                </div>
            </div>
            <div
                class="reveal reveal-delay-1 soft-card p-8 bg-gradient-to-br from-sage-50/80 via-cream-50 to-gold-50/50 border border-sage-200/80">
                ...
                <x-ui.button href="{{ route('contact') }}#support" variant="primary"
                    class="mt-6 w-full rounded-xl">Support Amazing Grace Academy</x-ui.button>
            </div>
        </div>
    </section>
    ...
    <section class="border-y border-ink-100 bg-cream-200/50 py-12">
        <div
            class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-6 text-center md:flex-row md:text-left">
            ...
            <div class="reveal flex flex-wrap justify-center gap-3 text-xs text-ink-700">
                <span class="pill bg-white/90 border border-sage-200/80 text-sage-800 font-medium">300+ choristers
                    impacted</span>
                <span class="pill bg-white/90 border border-sage-200/80 text-sage-800 font-medium">4+ albums &
                    programs</span>
                <span class="pill bg-white/90 border border-sage-200/80 text-sage-800 font-medium">Ministry across
                    Rwanda</span>
            </div>
        </div>
    </section>
