...
@section('content')
    ...
    <section class="mx-auto max-w-7xl px-6 pb-20">
        <div class="grid gap-10 lg:grid-cols-2">
            ...
            <x-ui.card class="p-10 bg-slate-900/80 border border-slate-700/80 text-slate-50 reveal">
                <h2 class="text-2xl font-semibold">What We Teach</h2>
    ...
    <section class="bg-slate-950/80 py-20 text-white">
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid gap-10 lg:grid-cols-2">
                ...
                <div class="rounded-[28px] bg-white/5 p-10 backdrop-blur reveal">
    ...
    <section class="mx-auto max-w-7xl px-6 py-20">
        <h2 class="text-3xl font-semibold text-center text-slate-50">
            Impact & Achievements
        </h2>

        <div class="mt-12 grid gap-6 md:grid-cols-3">
            <x-ui.card class="p-8 text-center bg-slate-900/80 border border-slate-700/80 reveal">
                <div class="text-3xl font-semibold text-emerald-300">700+</div>
                <div class="mt-2 text-sm text-slate-300">Students trained since 2016</div>
            </x-ui.card>

            <x-ui.card class="p-8 text-center bg-slate-900/80 border border-slate-700/80 reveal">
                <div class="text-3xl font-semibold text-sky-300">168</div>
                <div class="mt-2 text-sm text-slate-300">Sol-Fa graduates</div>
            </x-ui.card>

            <x-ui.card class="p-8 text-center bg-slate-900/80 border border-slate-700/80 reveal">
                <div class="text-3xl font-semibold text-purple-300">15+</div>
                <div class="mt-2 text-sm text-slate-300">ABRSM international certificates</div>
            </x-ui.card>
        </div>

        <p class="mt-10 max-w-3xl mx-auto text-center text-slate-300">
    ...
    <section class="mx-auto max-w-7xl px-6 pb-24">
        <x-ui.card class="p-10 bg-slate-900/80 border border-slate-700/80 text-slate-50 reveal">
            <h2 class="text-2xl font-semibold">Affiliations & Structure</h2>
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4 text-sm text-slate-100">
