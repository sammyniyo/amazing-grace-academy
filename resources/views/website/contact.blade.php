...
@section('content')
            ...
            <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-center">
                <div class="reveal space-y-5">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <x-ui.button href="#contact-form" variant="primary" class="md:order-2">
                            Send a message
                        </x-ui.button>
                        <x-ui.button href="tel:+250788261729" variant="outline" class="md:order-1">
                            Call Us
                        </x-ui.button>
                        <x-ui.button href="mailto:amazinggraceacademyrwanda@gmail.com" variant="glass" class="hidden sm:inline-flex">
                            Email Us
                        </x-ui.button>
                        <x-ui.button href="{{ url('/register') }}" variant="outline" class="hidden sm:inline-flex">
                            Class Register
                        </x-ui.button>
                    </div>
                </div>
    ...
    {{-- CONTACT GRID: form first on mobile so users reach it without long scroll --}}
    <section class="mx-auto max-w-7xl px-6 pb-20">
        <div class="grid gap-10 lg:grid-cols-2">
            {{-- CONTACT FORM (order-1 on mobile = first; order-2 on lg = right column) --}}
            <div id="contact-form" class="soft-card p-10 reveal order-1 lg:order-2">
            ...
            {{-- CONTACT DETAILS (order-2 on mobile = below form; order-1 on lg = left column) --}}
            <div class="soft-card p-10 reveal order-2 lg:order-1">
