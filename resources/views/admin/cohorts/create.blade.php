...
@section('content')
    <div class="max-w-3xl">
        <form method="POST" action="{{ route('admin.cohorts.store') }}"
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input name="location" value="{{ old('location') }}"
                        class="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm focus:border-emerald-300 focus:ring focus:ring-emerald-100"
                        placeholder="Kigali Bilingual Church">
                </div>
            </div>
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm focus:border-emerald-300 focus:ring focus:ring-emerald-100">{{ old('description') }}</textarea>
            </div>
